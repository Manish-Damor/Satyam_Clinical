-- ============================================================
-- SATYAM CLINICAL - COMPLETE PHARMACY ERP SYSTEM DATABASE
-- ============================================================
-- Complete, production-ready database schema
-- Combines all modules: ERP, Purchase Invoicing, Inventory
-- Ready to import in ONE GO without any issues
-- ============================================================

-- Drop existing database and create fresh
DROP DATABASE IF EXISTS satyam_clinical_new;
...
(1, 'satyam_clinic', '0f2cdafc6b1adf94892b17f355bd9110', 'satyamclinical@gmail.com', 'manager', 1);
-- (2, 'admin', '0f2cdafc6b1adf94892b17f355bd9110', 'admin@satyamclinical.com', 'admin', 1),
...
(4, 'SUP004', 'MicroLabs Pvt Ltd', '9876543213', 'Industrial Area', 'Bangalore', 'Karnataka', 'Active'),
(5, 'SUP005', 'Dr. Reddy Laboratories', '9876543214', 'Pharma Zone', 'Hyderabad', 'Telangana', 'Active');
...
(2, 'Aspirin 500mg', 'Aspirin 500mg', 2, 1, 'Tablet', 'Strip', '10x10', '30045010', 5.00, 40, 1),
(3, 'Amoxicillin 500mg', 'Amoxicillin 500mg', 3, 1, 'Capsule', 'Strip', '10x10', '30049099', 5.00, 30, 1),
...
(2, 2, 'ASP240101', '2024-01-10', '2026-07-15', 120, 15.00, 30.00, 'Active'),
(3, 3, 'AMX240101', '2024-01-05', '2025-12-31', 80, 25.00, 50.00, 'Active'),
(4, 2, 'PAN240101', '2024-02-01', '2026-09-30', 200, 40.00, 80.00, 'Active'),
(5, 4, 'IBU240101', '2024-01-15', '2026-05-20', 175, 12.00, 25.00, 'Active'),
(6, 5, 'VIT240101', '2024-01-20', '2026-10-15', 130, 22.00, 45.00, 'Active'),
(7, 2, 'COFF240101', '2024-01-01', '2025-12-31', 50, 45.00, 90.00, 'Active'),
(8, 1, 'CALS240101', '2024-02-10', '2026-08-20', 40, 55.00, 110.00, 'Active');
...
-- ============================================================
-- PURCHASE ORDERS & RECEIVABLES TABLES
-- ============================================================
...
CREATE TABLE purchase_invoice_items (
  ...
  CONSTRAINT fk_inv_items_product
    FOREIGN KEY (product_id)
    REFERENCES product(product_id)
    ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 12. GOODS RECEIVED NOTE (GRN) TABLE
...
CREATE TABLE grn_items (
  ...
  CONSTRAINT fk_grn_items_grn
    FOREIGN KEY (grn_id)
    REFERENCES goods_received(grn_id)
    ON DELETE CASCADE,
    
  CONSTRAINT fk_grn_items_product
    FOREIGN KEY (product_id)
    REFERENCES product(product_id)
    ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 14. STOCK BATCHES TABLE
...
-- 16. INVENTORY ADJUSTMENTS TABLE
...
-- 19. ORDERS TABLE (Sales/Invoices)
CREATE TABLE orders (
  id INT UNSIGNED NOT NULL AUTO_INCREMENT,
