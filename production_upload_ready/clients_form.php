...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $clientData['status'] = normalizeClientStatus($clientData['status'] ?? 'ACTIVE');
    } else {
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <?php if ($editMode): ?>
                                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($clientData['client_code']); ?>" readonly />
                                    <input type="hidden" name="client_code" value="<?php echo htmlspecialchars($clientData['client_code']); ?>" />
                                    <small class="text-muted">Format: CL-<?php echo date('Y'); ?>-0001 (year-wise sequence)</small>
                                <?php else: ?>
                                    <input type="text" class="form-control" value="Auto-generated on save (e.g., CL-<?php echo date('Y'); ?>-0001)" readonly />
                                    <small class="text-muted">Client code is generated automatically. Manual entry is disabled.</small>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-9">
