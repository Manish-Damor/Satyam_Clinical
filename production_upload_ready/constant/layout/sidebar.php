 ...
 function isInventoryReportActive($targetType, $currentPage)
 {
     if ($currentPage === 'productreport.php' && $targetType === 'inventory_summary') {
         return true;
     }
     if ($currentPage === 'expreport.php' && $targetType === 'expiry_tracking') {
         return true;
     }
     if ($currentPage !== 'inventory_reports.php') {
         return false;
     }

     $currentType = isset($_GET['type']) ? trim((string) $_GET['type']) : 'inventory_summary';
     if ($currentType === '') {
         $currentType = 'inventory_summary';
     }
 ...
 $reportsOpen = isActivePage(['sales_report.php', 'productreport.php', 'expreport.php', 'inventory_reports.php', 'report.php', 'salesreport.php'], $currentPage);
 ?>
...
<li class="<?php echo $reportsOpen ? 'active' : ''; ?>"> <a class="has-arrow <?php echo $reportsOpen ? 'active' : ''; ?>" href="javascript:void(0)" aria-expanded="<?php echo $reportsOpen ? 'true' : 'false'; ?>"><i class="fa fa-area-chart icon-reports"></i><span class="hide-menu">Reports</span></a>
                      ...
                      <li><a href="sales_report.php" class="<?php echo isActivePage(['sales_report.php', 'report.php', 'salesreport.php'], $currentPage) ? 'active' : ''; ?>">Sales Analytics</a></li>
                          <li><a href="inventory_reports.php?type=inventory_summary" class="<?php echo isInventoryReportActive('inventory_summary', $currentPage) ? 'active' : ''; ?>">Inventory Summary</a></li>
                          <li><a href="inventory_reports.php?type=expiry_tracking" class="<?php echo isInventoryReportActive('expiry_tracking', $currentPage) ? 'active' : ''; ?>">Expiry Tracking</a></li>
                          <li><a href="inventory_reports.php?type=stock_movements" class="<?php echo isInventoryReportActive('stock_movements', $currentPage) ? 'active' : ''; ?>">Stock Movements</a></li>
                       </ul>
                        </li>
                  <?php }?>
