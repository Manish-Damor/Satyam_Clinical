        ...
        <div class="header">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="nav-toggler" href="javascript:void(0)" aria-label="Toggle sidebar menu">
                        <i class="mdi mdi-menu"></i>
                    </a>
                    <a class="sidebartoggler" href="javascript:void(0)" aria-label="Toggle sidebar width">
                        <i class="ti-menu"></i>
                    </a>
                    <a class="navbar-brand" href="index.php">
                        
                         
                        <b><img src="./assets/uploadImage/Logo/logo.jpeg" style="width: 100%;" alt="homepage" class="dark-logo" style="width:100%;height:auto;"/></b>
