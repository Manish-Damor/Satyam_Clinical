        ...
        <form id="editInvoiceForm" method="POST" action="php_action/po_edit_action.php">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select name="payment_mode" class="form-control">
                                    ...
                                    <option value="Cheque" <?=in_array($invoice['payment_mode'], ['Cheque','Check'])?'selected':''?>>Cheque</option>
                                    <option value="Bank" <?=in_array($invoice['payment_mode'], ['Bank','Bank Transfer'])?'selected':''?>>Bank Transfer</option>
            ...
            <div class="row mt-3 mb-3">
                <div class="col-md-12">
                    ...
                    <a href="invoice_view.php?id=<?=$invoiceId?>" class="btn btn-secondary">
    ...
    $('#editInvoiceForm').submit(function(e) {
        ...
        $('#itemsBody tr').each(function() {
            const item = {
                ...
                hsn_code: $(this).find('.hsn-code').val(),
